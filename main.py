...
from detectron2_paintings_detection_segmentation import detect_and_segment_paintings
...
def exercise_one(videoPath, frame_rate=10):
    ...
    while (cap.isOpened()):
        ...
        if ret is True and frame_count % frame_rate == 0:
            frame_with_segmented_paintings, triple_paintings_boxes_masks = detect_and_segment_paintings(frame, False)
            ...
            for tpbm in triple_paintings_boxes_masks:
                rectified, originalImagePointsForProspectiveTransformations, is_rect, vp_rectified, vp_originalImagePointsForProspectiveTransformations, vps_failed = rectify(frame, tpbm[2])
...
if __name__ == "__main__":
    ...
    parser.add_argument("-owd", "--opencv_waitkey_delay", help = "Specify the delay in ms for opencv cv2.waitKey(x) function", type=int)
    ...
    #exercise_one('D:/Shared-Data/Materie-Magistrale/Vision And Cognitive Systems/Project/Project material/videos/012/IMG_4081.MOV', 20)
    #exercise_one('D:/Shared-Data/Materie-Magistrale/Vision And Cognitive Systems/Project/Project material/videos/003/GOPR1928.MP4', 20)
    #exercise_one('D:/Shared-Data/Materie-Magistrale/Vision And Cognitive Systems/Project/Project material/videos/004/IMG_3808.MOV', 20)
    #exercise_one('D:/Shared-Data/Materie-Magistrale/Vision And Cognitive Systems/Project/Project material/videos/000/VIRB0399.MP4', 20)
    #exercise_one('D:/Shared-Data/Materie-Magistrale/Vision And Cognitive Systems/Project/Project material/videos/002/20180206_111817_Trim.mp4', 10)
    #exercise_optional_b()
